...
const MATS = [
  {m:'Цегла керамічна',       t:'250 мм',     db:52,norm:'ДСТУ Б В.2.6-85:2009',  use:'Зовн./несучі стіни'},
  {m:'Залізобетон',           t:'200 мм',     db:57,norm:'ДСТУ Б В.2.6-85:2009',  use:'Несучі стіни, перекриття'},
  ...
  {m:'Дерево (масив)',        t:'100 мм',     db:38,norm:'ДСТУ Б В.2.6-85:2009',  use:'Перекриття'},
