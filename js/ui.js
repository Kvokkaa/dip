...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <table class="grid">
    ...
    <tr><td>Категорія об'єкта (НД ТЗІ 1.6-005-2013)</td><td>${a.catName||res.cls}</td></tr>
  ...
  <div class="foot">
    ...
    Категорії об'єктів за НД ТЗІ 1.6-005-2013, норми розбірливості — за методикою Покровського–Хорєва. Документ сформовано автоматично системою КСЗІ v3.0.
  </div>
